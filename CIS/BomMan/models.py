...
class BOM(models.Model):
    ...
    customer = models.ForeignKey('SysSetting.ObjectCode', verbose_name=u'客户分类', on_delete=models.CASCADE,
                                 related_name='cus_bom', limit_choices_to={'object_name__contains': '客户'})
    product = models.ForeignKey('SysSetting.ObjectCode', verbose_name=u'产品类型', on_delete=models.CASCADE,
                                related_name='pro_bom', limit_choices_to={'object_name__contains': '光缆型号'})
    cable_structure = models.ForeignKey('SysSetting.ObjectCode', verbose_name=u'光缆结构', on_delete=models.CASCADE,
                                        related_name='cs_bom', limit_choices_to={'object_name__contains': '光缆结构'})
    steel_wire = models.ForeignKey('SysSetting.ObjectCode', verbose_name=u'钢丝型号', on_delete=models.CASCADE,
                                   related_name='sw_bom', limit_choices_to={'object_name__contains': '钢丝'}, null=True,
                                   blank=True)
    aluminum_band = models.ForeignKey('SysSetting.ObjectCode', verbose_name=u'铝带型号', on_delete=models.CASCADE,
                                      related_name='ab_bom', limit_choices_to={'object_name__contains': '铝带'},
                                      null=True, blank=True)
    steel_band = models.ForeignKey('SysSetting.ObjectCode', verbose_name=u'钢带型号', on_delete=models.CASCADE,
                                   related_name='sb_bom', limit_choices_to={'object_name__contains': '钢带'}, null=True,
                                   blank=True)
